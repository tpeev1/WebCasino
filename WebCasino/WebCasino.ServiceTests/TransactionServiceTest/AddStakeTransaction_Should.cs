...
{
    [TestClass]
    public class AddStakeTransaction_Should
    {
        ...
        {
            var contextOptions = new DbContextOptionsBuilder<CasinoContext>()
                .UseInMemoryDatabase(databaseName: "LossThrowEntityCurrencyNotFoundException_WhenUserUseUnMaitainableCurrency")
                .Options;
            ...
            using (var context = new CasinoContext(contextOptions))
            {
                ...
                await Assert.ThrowsExceptionAsync<EntityCurrencyNotFoundException>(() => transactionService.AddStakeTransaction(userId, amountInUserCurrency, description));
            }
        }
